...
>> Bayesian statistics use probabilities for priors as well as observed data.
>> Frequentist statistics never uses given probability of a hypothesis and depends on likelihood for observed and unobserved data.
